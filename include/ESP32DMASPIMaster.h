...
#ifndef ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_BEGIN
#define ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_BEGIN \
    namespace arduino {                       \
    namespace esp32 {                         \
        namespace spi {                       \
            namespace dma {                   \
...
#endif
#ifndef ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_END
#define ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_END \
    }                                       \
    }                                       \
    }                                       \
    }                                       \
    }   // namespace arduino::esp32::spi::dma::master
#endif

ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_BEGIN
...
ARDUINO_ESP32_DMA_SPI_MASTER_NAMESPACE_END

namespace ESP32DMASPIMaster = arduino::esp32::spi::dma::master;
